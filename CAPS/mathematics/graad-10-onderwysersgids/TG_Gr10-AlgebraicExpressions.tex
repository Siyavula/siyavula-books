...
\begin{multicols}{2}
    \begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ] 
    \item $2,82843$ - irrasionaal%$\sqrt{8}$
    \item $27,71281$ - irrasionaal %$\sqrt{768}$
%     \item $10,00000$ - rasional 
    \item $0,70000$ - rasionaal  %$\sqrt{0,49}$
    \item $0,04000$ - rasionaal %%$\sqrt{0,0016}$
    \item $0,500000$ - rasionaal  %$\sqrt{0,25}$
    \item $6,00000$ - rasionaal  %$\sqrt{36}$
    \item $44,27189$ - irrasionaal  %$\sqrt{1960}$
    \item $0,06000$ - rasionaal  %$\sqrt{0,0036}$
    \item $-4,00000$ - rasionaal  %$-8\sqrt{0,04}$
    \item $44,72136$ - irrasionaal %$5\sqrt{80}$
    \end{enumerate}
\end{multicols}
% \setcounter{enumi}{8}
